...
User signed in
+------------------------------------------------------------------------------------------------------+
| HEALTH TRACKER [ Move home button to title? ] --- [ Home ] [ Profile ] [ Trackers ] [ Reports ] [ Meet the Team ] [ Sign Out ] |
|------------------------------------------------------------------------------------------------------|
| About the App                                                                                        |
|                                                                                                      |
+------------------------------------------------------------------------------------------------------+
...
User not Signed in
+-------------------------------------------------------------------------------------------------------+
| HEALTH TRACKER [ Move home button to title? ] --- [ Home ] [ Register ] [ Meet the Team ] [ Sign In ] |
|------------------------------------------------------------------------------------------------------ |
| About the App                                                                                         |
|                                                                                                       |
+-------------------------------------------------------------------------------------------------------+
